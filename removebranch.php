...
<form name="form1" method="post" action="removebranch.php"  >
...
error_reporting(E_ALL ^ E_DEPRECATED);
  ...
  {
	  extract($_POST);
	$sql="select * from branches where name like '$searchv%'";
  ...
  <tr>
    ...
    <td><a href="removeb.php?id=<?php echo $r[0];?>"><?php echo 'Remove';?></a>
